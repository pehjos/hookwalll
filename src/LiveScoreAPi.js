...
<div className="topics_container__c">
    <div className="topics_container__icons">
        <div>
    <p className="blinking">LIVE SCORES</p>
    </div>
    <Link to="/sports">
        <div className="topics_icons">
    <SportsVolleyballOutlined/>
